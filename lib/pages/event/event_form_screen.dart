...
class EventFormScreen extends StatefulWidget {
  static const String routeName = "/EventFormScreen";
...
class EventFormScreenState extends State<EventFormScreen> {
  ...
  String _verticalGroupValue1 = "School";
  final List<String> _status1 = [
    "School",
    "College",
  ];
  ...
  final userParents = TextEditingController();
  ...
  final userSchoolAndCollegeNameController = TextEditingController();
  final userSchoolAndCollegeQualificationController = TextEditingController();
  ...
  void dispose() {
    ...
    userSchoolAndCollegeNameController.dispose();
    userSchoolAndCollegeQualificationController.dispose();
                        ...
                        children: [
                          ...
                          TextFormField(
                            decoration: const InputDecoration(
                              ...
                              hintText: 'Please Enter Your Parents/Guardian Name',
                            ),
                            validator: (value) => value!.length < 2
                                ? 'Parents/Guardian name should be minimum 3 character'
                                : null,
                            controller: userParents,
                          ),
                          const SizedBox(height: 15),
                          TextFormField(
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                              border: OutlineInputBorder(),
                              labelText: 'Parents/Guardian phone number*',
                              hintText: 'Enter Parents/Guardian phone number',
                            ),
                            validator: (value) => value!.length < 6
                                ? 'phone number is not valid.'
                                : null,
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFormField(
                            decoration: const InputDecoration(
                              border: OutlineInputBorder(),
                              labelText: 'School/College/Institution Name',
                              hintText: 'Please Enter Name',
                            ),
                            validator: (value) => value!.length < 2 ? 'Name is not valid.' : null,
                            controller: userSchoolAndCollegeNameController,
                          ),
                          ...
                          TextFormField(
                            ...
                            validator: (value) => value!.length < 2 ? 'Name is not valid.' : null,
                            controller: userSchoolAndCollegeQualificationController,
                          ),
  ...
  continued() async {
    if (formKey.currentState!.validate()) {
      ...
      final parentsName = userParents.value.text;
      final parentsPhoneNumber = parentPhoneNumberController.value.text;


      final school_Collage_Name = userSchoolAndCollegeNameController.value.text;
      final qualification = userSchoolAndCollegeQualificationController.value.text;
      final otherTalent = userOtherTalentController.value.text;

      if(!school_Collage_Name.isEmptyOrNull && !qualification.isEmptyOrNull ) {

        if(_verticalGroupValue2 == "Others") {
          if(otherTalent.isEmptyOrNull) {
            Fluttertoast.showToast(
                msg: "Please mention your specific Talent!",
          ...
          if(!agree) {
            ...
            final Map<String, dynamic> educationDetail = <String, dynamic>{};
            educationDetail['institutionName'] = school_Collage_Name;
            educationDetail['institutionType'] = _verticalGroupValue1;
            educationDetail['courseDetails'] = qualification;


            final Map<String, dynamic> partentDetails = <String, dynamic>{};
            partentDetails['isGuardian'] = true;
            partentDetails['parentName'] = parentsName;
            partentDetails['parentMobileNo'] = parentsPhoneNumber;
            ...
            data['partentDetails'] = partentDetails;
